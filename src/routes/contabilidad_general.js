...
router.get('/estados_financieros/BALANCE_DE_COMPROBACION_INICIAL/:ID_ESTADOFINANCIERO', isLoggedIn, async (req, res) => {
        ...
        res.render('contabilidad_general/balance_de_comprobacion_inicial', {estadofinanciero, periodocontable:periodoscontables[0], idioma, cuentas_deudoras, cuentas_acreedoras, suma_debe:sumas_debe[0], suma_haber:sumas_haber[0]});
    });
    
    //-----------------------------------BALANCE DE COMPROBACION---------------------------------------------------------
    router.get('/estados_financieros/BALANCE_DE_COMPROBACION/:ID_ESTADOFINANCIERO', isLoggedIn, async (req, res) => {
        const { ID_ESTADOFINANCIERO } = req.params;
        const estadofinanciero = await pool.query('SELECT * FROM estadofinanciero WHERE ID_ESTADOFINANCIERO = ?', [ ID_ESTADOFINANCIERO ]);
        const idioma = await pool.query('SET lc_time_names = "es_VE"');
        const periodoscontables = await pool.query('SELECT DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%d") AS FECHAINICIO, DATE_FORMAT(periodocontable.FECHAFINAL_PERIODO, "%d") AS FECHAFINAL, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%M") AS MES, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%Y") AS ANIO ' +
        ...
        const sumas_debe = await(pool.query('SELECT ROUND(SUM(mayorizacion.MONTO_SALDO), 2) AS DEBE FROM mayorizacion INNER JOIN estadofinanciero_mayorizacion ON mayorizacion.ID_MAYORIZACION= estadofinanciero_mayorizacion. ID_MAYORIZACION INNER JOIN estadofinanciero ON estadofinanciero.ID_ESTADOFINANCIERO= estadofinanciero_mayorizacion. ID_ESTADOFINANCIERO INNER JOIN periodocontable ON periodocontable.ID_PERIODOCONTABLE= estadofinanciero.ID_PERIODOCONTABLE WHERE estadofinanciero .ID_ESTADOFINANCIERO=? AND mayorizacion.ES_SALDO_ACREEDOR="NO"', [ID_ESTADOFINANCIERO]));
        const sumas_haber = await(pool.query('SELECT ROUND(SUM(mayorizacion.MONTO_SALDO), 2) AS HABER FROM mayorizacion INNER JOIN estadofinanciero_mayorizacion ON mayorizacion.ID_MAYORIZACION= estadofinanciero_mayorizacion. ID_MAYORIZACION INNER JOIN estadofinanciero ON estadofinanciero.ID_ESTADOFINANCIERO= estadofinanciero_mayorizacion. ID_ESTADOFINANCIERO INNER JOIN periodocontable ON periodocontable.ID_PERIODOCONTABLE= estadofinanciero.ID_PERIODOCONTABLE WHERE estadofinanciero .ID_ESTADOFINANCIERO=? AND mayorizacion.ES_SALDO_ACREEDOR="SI"', [ID_ESTADOFINANCIERO]));
        res.render('contabilidad_general/balance_de_comprobacion', {estadofinanciero, periodocontable:periodoscontables[0], idioma, cuentas_deudoras, cuentas_acreedoras, suma_debe:sumas_debe[0], suma_haber:sumas_haber[0]});
    });

    //--------------------------------------ESTADO DE RESULTADOS---------------------------------------------------------
    router.get('/estados_financieros/ESTADO_DE_RESULTADOS/:ID_ESTADOFINANCIERO', isLoggedIn, async (req, res) => {
        const { ID_ESTADOFINANCIERO} = req.params;
        const estadofinanciero = await pool.query('SELECT * FROM estadofinanciero WHERE ID_ESTADOFINANCIERO = ?', [ ID_ESTADOFINANCIERO ]);
        const idioma = await pool.query('SET lc_time_names = "es_VE"');
        const periodoscontables = await pool.query('SELECT DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%d") AS FECHAINICIO, DATE_FORMAT(periodocontable.FECHAFINAL_PERIODO, "%d") AS FECHAFINAL, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%M") AS MES, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%Y") AS ANIO ' +
    ...
    //----------------------------------------ESTADO DE CAPITAL---------------------------------------------------------
    router.get('/estados_financieros/ESTADO_DE_CAPITAL/:ID_ESTADOFINANCIERO', isLoggedIn, async (req, res) => {
        const { ID_ESTADOFINANCIERO } = req.params;
        const estadofinanciero = await pool.query('SELECT * FROM estadofinanciero WHERE ID_ESTADOFINANCIERO = ?', [ ID_ESTADOFINANCIERO ]);
        const idioma = await pool.query('SET lc_time_names = "es_VE"');
        const periodoscontables = await pool.query('SELECT DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%d") AS FECHAINICIO, DATE_FORMAT(periodocontable.FECHAFINAL_PERIODO, "%d") AS FECHAFINAL, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%M") AS MES, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%Y") AS ANIO ' +
        ...
        res.render('contabilidad_general/estado_de_capital', {estadofinanciero, periodocontable:periodoscontables[0], idioma, cuentas_patrimonio, total});
    });
    
    //---------------------------------------BALANCE GENERAL---------------------------------------------------------
    router.get('/estados_financieros/BALANCE_GENERAL/:ID_ESTADOFINANCIERO',isLoggedIn, async (req, res) => {
        const { ID_ESTADOFINANCIERO } = req.params;
        const estadofinanciero = await pool.query('SELECT * FROM estadofinanciero WHERE ID_ESTADOFINANCIERO = ?', [ ID_ESTADOFINANCIERO ]);
        const idioma = await pool.query('SET lc_time_names = "es_VE"');
        const periodoscontables = await pool.query('SELECT DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%d") AS FECHAINICIO, DATE_FORMAT(periodocontable.FECHAFINAL_PERIODO, "%d") AS FECHAFINAL, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%M") AS MES, DATE_FORMAT(periodocontable.FECHAINICIO_PERIODO, "%Y") AS ANIO ' +
    ...
    router.get('/estados_financieros/ESTADO_DE_FLUJO_DE_EFECTIVO/:ID_ESTADOFINANCIERO',isLoggedIn,  async (req, res) => {
        const { ID_ESTADOFINANCIERO } = req.params;
        const estadofinanciero = await pool.query('SELECT * FROM estadofinanciero WHERE ID_ESTADOFINANCIERO = ?', [ ID_ESTADOFINANCIERO ]);
        const idioma = await pool.query('SET lc_time_names = "es_VE"');
    ...
    router.get('/estados_financieros/:NOMBRE_ESTADOFINANCIERO/:ID_ESTADOFINANCIERO/notas_explicativas/listado/agregar',isLoggedIn,  (req, res) => {
        //const { ID_ESTADOFINANCIERO } = req.params;
        //console.log({ID_ESTADOFINANCIERO});
    ...
    router.post('/estados_financieros/:NOMBRE_ESTADOFINANCIERO/:ID_ESTADOFINANCIERO/notas_explicativas/listado/agregar',isLoggedIn,  async (req, res) => {
    ...
    router.get('/estados_financieros/listado',isLoggedIn,  async (req, res) => {
    ...
    router.get('/estados_financieros/:NOMBRE_ESTADOFINANCIERO/:ID_ESTADOFINANCIERO',isLoggedIn,  async (req, res) => {
        const { NOMBRE_ESTADOFINANCIERO } = req.params;
        const { ID_ESTADOFINANCIERO } = req.params;
...
router.get('/transaccion',isLoggedIn,  async (req, res) => {
...
router.post('/transaccion',isLoggedIn,  async (req, res, next) => {
...
router.post('/transaccion/estadosfinancieros',isLoggedIn, async (req, res, next) => {
        const { FECHAFINAL_PERIODO, ID_PERIODOCONTABLE, ID_CUENTA, CANTIDAD_CUENTAS} = req.body;
        console.log(ID_PERIODOCONTABLE);
        console.log(FECHAFINAL_PERIODO);
        console.log('Fila actualizada correctamente de periodocontable');
...
//Mostrar transaccion
router.get('/transaccion/ver_transaccion/:ID_TRANSACCION',isLoggedIn, async (req, res) => {
        const {ID_TRANSACCION} = req.params;
        const ID_TRANSACCION_AJUSTE = 1;
        ...
        "INNER JOIN cuenta ON cuenta.ID_CUENTA=movimiento.ID_CUENTA WHERE transaccion.ID_TRANSACCION = ? AND movimiento.COD_ID_TRANSACCION_AJUSTE = ?", [ID_TRANSACCION, ID_TRANSACCION_AJUSTE]);
...
router.get('/transaccion/ver_transaccion_impuesto/:ID_TRANSACCION/:ES_IMPUESTO',isLoggedIn, async (req, res) => {
...
router.get('/transaccion/agregar_transaccion/',isLoggedIn, async (req, res, next) => {
...
router.post('/transaccion/agregar_transaccion',isLoggedIn, async (req, res, next) => {
        ...
        var COD_ID_TRANSACCION_AJUSTE = 1;
        ...
        for(var k = 0; k<cantidad-1; k++){
                var new_movimiento = {
                        ...
                        COD_ID_TRANSACCION_AJUSTE: ID_TRANSACCION_AJUSTE
                };
                ...
                const saldo_cuenta = await pool.query('SELECT SALDO_CUENTA FROM cuenta WHERE ID_CUENTA=?', [new_movimiento.ID_CUENTA]);
                ...
                }else if(naturaleza_cuenta[0].ID_NATURALEZA_CUENTA == 2){
                        saldo_new = saldo_cuenta[0].SALDO_CUENTA - montoCargo + montoAbono;
...
router.get('/asiento_ajuste', isLoggedIn, async (req, res, next) => {
...
router.get('/asiento_ajuste/ver_sin_ajuste/:ID_TRANSACCION', isLoggedIn, async (req, res) => {
        const {ID_TRANSACCION} = req.params;
...
router.get('/asiento_ajuste/ver_ajuste/:ID_TRANSACCION', isLoggedIn, async (req, res) => {
        const {ID_TRANSACCION} = req.params;
        const transacciones = await pool.query("SELECT ID_TRANSACCION, tipotransaccion.NOMBRE_TIPO_TRANSACCION, transaccion.DESCRIPCION_TRANSACCION, "+
        ...
        "transaccion.COD_ID_TRANSACCION_AJUSTE=transaccionajuste.ID_TRANSACCION_AJUSTE WHERE transaccion.ID_TRANSACCION = ?", [ID_TRANSACCION]);
        const movimientos = await pool.query("SELECT DATE_FORMAT(movimiento.FECHA_MOVIMIENTO, '%Y-%m-%d') AS FECHA_MOVIMIENTO_FORMATO, movimiento.DETALLE_MOVIMIENTO, "+
        "movimiento.MONTO_CARGO, movimiento.MONTO_ABONO, cuenta.NOMBRE_CUENTA FROM transaccion INNER JOIN movimiento On transaccion.ID_TRANSACCION=movimiento.ID_TRANSACCION "+
...
router.get('/asiento_ajuste/agregar_ajuste/:ID_TRANSACCION/:NOMBRE_TIPO_TRANSACCION/:MONTO_TRANSACCION/:FECHA_TRANSACCION_FORMATO', isLoggedIn, async (req, res, next) => {
        ...
        if(fecha_n == 01){
                ...
                var dias = parseInt(FECHA_TRANSACCION_FORMATO);//Fecha transaccion
                var resta = dias - fecha_n;
                var mes = 0;
                var inicial = 01;
                function sumarDias(inicial, resta){
                        fecha_new = inicial + resta;
                        return fecha_new;
                }
                console.log("Suma del mes: "+sumarDias(inicial, resta));

                //Evaluando la fecha en que se realizo la transaccion
                if(sumarDias(inicial, resta) >= '1' && sumarDias(inicial, resta) <= '12'){
                        mes = 1;
                }else{
                        if(sumarDias(inicial, resta) >= '13' && sumarDias(inicial, resta) <= '27'){
                                mes = 0.5;
                        }
                }
        }
...
router.post('/asiento_ajuste/agregar_ajuste/:ID_TRANSACCION', isLoggedIn, async (req, res, next) => {
        const { ID_TRANSACCION } = req.params;
        ...
        await pool.query("UPDATE transaccion SET COD_ID_TRANSACCION_AJUSTE = ?, ES_AJUSTE = ? WHERE ID_TRANSACCION = ? ", [id_transaccion_ajuste[0].ID_TRANSACCION_AJUSTE, ES_AJUSTE, ID_TRANSACCION]);
        const COD_ID_TRANSACCION_AJUSTE = id_transaccion_ajuste[0].ID_TRANSACCION_AJUSTE;
        for(var k = 0; k<cantidad-1; k++){
                var new_movimiento = {
                        ID_CUENTA:ID_CUENTA_NUM[k],
                        FECHA_MOVIMIENTO,
...
router.get('/catalogo/ver_cuenta/:ID_CUENTA', isLoggedIn, async (req, res) => {
...
router.get('/catalogo/agregar_cuenta', isLoggedIn, async (req, res, next) => {
...
router.post('/catalogo/agregar_cuenta', isLoggedIn, async (req, res, next) => {
...
router.get('/catalogo/agregar_subcuenta', isLoggedIn, async (req, res, next) => {
        const rubro = await pool.query('SELECT * FROM cuenta WHERE NIVELH = 2');
        const naturaleza = await pool.query('SELECT * FROM naturaleza');
        res.render('contabilidad_general/agregar_subcuenta', {rubro, naturaleza});
});
router.post('/catalogo/agregar_subcuenta', isLoggedIn, async (req, res, next) => {
...
router.get('/catalogo/agregar_subsubcuenta', isLoggedIn, async (req, res, next) => {
        const rubro = await pool.query('SELECT * FROM cuenta WHERE NIVELH = 2');
        const naturaleza = await pool.query('SELECT * FROM naturaleza');
        res.render('contabilidad_general/agregar_subsubcuenta', {rubro, naturaleza});
});
router.post('/catalogo/agregar_subsubcuenta', isLoggedIn, async (req, res, next) => {
...
router.get('/select_cuenta/:ID_CUENTA', isLoggedIn, async (req, res, next) => {
        const {ID_CUENTA} = req.params;
...
router.get('/select_subcuenta/:ID_CUENTA', isLoggedIn, async (req, res, next) => {
        const {ID_CUENTA} = req.params;
...
router.get('/select_subsubcuenta/:ID_CUENTA', isLoggedIn, async (req, res, next) => {
        const {ID_CUENTA} = req.params;
...
router.get('/listar_transaccion_select/:ID_PERIODOCONTABLE', isLoggedIn, async (req, res, next) => {
...
router.get('/listar_asiento_ajuste_select/:ID_PERIODOCONTABLE', isLoggedIn, async (req, res, next) => {
        const { ID_PERIODOCONTABLE }=req.params;
        const periodo = await pool.query("SELECT DATE_FORMAT(FECHAINICIO_PERIODO, '%d-%m-%Y') AS FECHA_PERIODO, DATE_FORMAT(FECHAFINAL_PERIODO, '%d-%m-%Y') "+
        "AS FECHA_PERIODO_FINAL FROM periodocontable WHERE ID_PERIODOCONTABLE = ?", [ID_PERIODOCONTABLE]);
...
router.get('/check_impuesto',isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/check_impuesto');
});
router.get('/input_interes_mes',isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/input_interes_mes');
});
router.get('/input_plazo_mes',isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/input_plazo_mes');
});
router.get('/input_plazo_a',isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/input_plazo_año');
});
router.get('/input_fecha_prestamo',isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/input_fecha_prestamo');
});
router.get('/input_vida_util',isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/input_vida_util');
});
router.get('/input_valor_recuperacion', isLoggedIn,  (req, res) => {
        res.render('contabilidad_general/input_valor_recuperacion');
});
router.get('/check_calcular_monto', isLoggedIn, (req, res) => {
        res.render('contabilidad_general/check_calcular_monto');
});
router.get('/input_cantidad', isLoggedIn, (req, res) => {
        res.render('contabilidad_general/input_cantidad');
});
router.get('/input_precio_unitario', isLoggedIn, (req, res) => {
        res.render('contabilidad_general/input_precio_unitario');
});

router.get('/monto_impuesto/:monto_tran', isLoggedIn,  async (req, res) => {
...
//Balance de Comprobacion
router.get('/estados_financieros/balance_comprobacion', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/balance_de_comprobacion');
});

//Balance General
router.get('/estados_financieros/balance_general', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/balance_general');
});

//Estado de Resultados
router.get('/estados_financieros/estado_resultados', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/estado_de_resultados');
});

//Estado de Capital
router.get('/estados_financieros/estado_capital', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/estado_de_capital');
});

//Estado de Flujo de Efectivo
router.get('/estados_financieros/estado_flujo_efectivo', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/estado_flujo_de_efectivo');
});

//Notas Explicativas (agregar)
router.get('/estados_financieros/agregar_nota_explicativa', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/agregar_nota_explicativa');
});

//Listado de Notas Explicativas 
router.get('/estados_financieros/notas_explicativas/listado', isLoggedIn, async (req, res) => {
    res.render('contabilidad_general/listado_notas_explicativas');
});

router.get('/planilla', isLoggedIn,  async (req, res) => {
...
router.get('/planilla/mostrar_empleado/:CODIGO_EMPLEADO', isLoggedIn, async (req, res) => {
...
router.post('/planilla/guardar/:CODIGO_EMPLEADO', isLoggedIn, async(req, res) => {
        const {CODIGO_EMPLEADO} = req.params;
